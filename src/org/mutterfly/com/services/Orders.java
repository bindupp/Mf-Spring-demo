...
import org.mutterfly.com.DataBase.GenericDaoClass;
...
public class Orders implements AllApplicationInterfaces.OrderMethods {
	...
	public List<OrderModel> getAllOrders() {
		...
		GenericDaoClass generate = new GenericDaoClass();
		
		data = generate.getDataSource();
		
		generate.jdbcTemplate.setDataSource(data);
		
		// jdbcTemplate.query("Select o_id from orders where o_resource_id = ?",new Object[]{167},new OrderMapper());
		
		
		
		return generate.jdbcTemplate.query("Select o_id from orders where o_resource_id = ? like 5",new Object[]{167},new OrderMapper());
